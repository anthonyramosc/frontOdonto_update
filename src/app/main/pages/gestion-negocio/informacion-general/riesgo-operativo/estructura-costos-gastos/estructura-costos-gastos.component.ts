...
@Component({
  selector: 'app-estructura-costos-gastos',
  templateUrl: './estructura-costos-gastos.component.html',
  styleUrls: ['./estructura-costos-gastos.component.scss']
})
export class EstructuraCostosGastosComponent implements OnInit {
  ...
  data: any;
    ...
    public estructuraCostosGastosForm: FormGroup;
    public producto: string = 'MATRIZ';
    balance: string = '0';
    constructor(
        private SigRfEstrBalanceService: EstructuraCostosGastosService,
    ...
    get f() {
        return this.estructuraCostosGastosForm.controls;
    }
    ngOnInit(): void {
    ...
    this.SigRfEstrBalanceService.getFechaBalance().then(res => {
        ...
        this.estructuraCostosGastosForm = this._formBuilder.group({
    ...
    onSubmit() {
        this.submitted = true;
        if (this.estructuraCostosGastosForm.invalid) {
