...
@Component({
  selector: 'app-liquidez-estructural',
  templateUrl: './liquidez-estructural.component.html',
  styleUrls: ['./liquidez-estructural.component.scss']
})
export class LiquidezEstructuralComponent implements OnInit {
  ...
  data: any;
    ...
    public liquidezEstructuralForm: FormGroup;
    public producto: string = 'MATRIZ';
    balance: string = '0';
    constructor(
        private SigRfEstrBalanceService: LiquidezEstructuralService,
    ...
    get f() {
        return this.liquidezEstructuralForm.controls;
    }
    ngOnInit(): void {
    ...
    this.SigRfEstrBalanceService.getFechaBalance().then(res => {
        ...
        this.liquidezEstructuralForm = this._formBuilder.group({
        ...
        this.contentHeader = {
            ...
            breadcrumb: {
                ...
                links: [
                    ...
                    {
                        name: 'Riesgo Liquidez',
                        isLink: 'gestion-negocio/informacion-genneral/riesgo-liquidez/'
                    },
                    {
                        name: 'Liquidez Estructural',
                        isLink: false
                    }
                ]
            }
    ...
    onSubmit() {
        this.submitted = true;
        if (this.liquidezEstructuralForm.invalid) {
    ...
    descargar(){
        this.scgSaldos = environment.apiUrl +"/liquidezestructural/generate";
